...
- **Sound** — three DOVA-SYNDROME Edo-flavored BGM tracks in rotation, with an original Web Audio chiptune (yō-scale pentatonic) as offline fallback
...
Three tracks from [DOVA-SYNDROME](https://dova-s.jp/) (free BGM, commercial use permitted, no credit required — credited anyway because they're great):
...
The audio files are included as part of this game under DOVA-SYNDROME's license terms; please don't extract and redistribute them standalone.
